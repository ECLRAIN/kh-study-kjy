...
public class Test03 {
	...
	//상황에 따라 기준에 따라 달라진다
	//비교 연산이 아니라 equals()를 재정의 하여 사용한다
	System.out.println(a==b); //a와 b가 쳐다보는 대상이 같아요? 아니 
	System.out.println(a.equals(b)); // a와 b의 값이 같아요?
	System.out.println(b.equals(c)); // a와 b의 값이 같아요?
	System.out.println(c.equals(d)); // a와 b의 값이 같아요?
	}
}
