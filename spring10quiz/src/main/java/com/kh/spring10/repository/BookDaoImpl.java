...
public class BookDaoImpl implements BookDao {
	...
	public void insert(BookDto bookDto) {
		String sql = "insert into book("
						...
						+ ")";
		Object[] param = {
			bookDto.getBookName(), bookDto.getBookWriter(),
			bookDto.getBookPublisher(), bookDto.getBookPrice(),
	...
	public boolean update(BookDto bookDto) {
		...
		Object[] param = {
			bookDto.getBookName(), bookDto.getBookWriter(),
			bookDto.getBookPublisher(), bookDto.getBookGenre(),
			bookDto.getBookPrice(), bookDto.getBookSerial()
		};
